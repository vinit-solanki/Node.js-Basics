...
app.get("/posts/new",(req,res)=>{
  res.render("newPosts",{posts});
})

app.post("/posts/new", (req, res) => {
  const { id, userId, content, img } = req.body;
  // Validate input fields (optional but recommended)
  if (!id || !userId || !content || !img) {
    return res.redirect("/error"); // Handle missing fields
  }
  ...
  // Redirect to the posts page (home in this case)
  res.redirect("/posts");
});
